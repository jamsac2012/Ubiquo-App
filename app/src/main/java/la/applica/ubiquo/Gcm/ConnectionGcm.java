 ...
 */
public class ConnectionGcm extends Activity {

    GoogleCloudMessaging gcm;
    ConnServer connBackend;
    String SENDER_ID = "29327334806";
    String regid;


    static final String TAG = "GCM Connection";
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    connBackend.sendRegistrationIdToBackend(regid);
                    ...
                    main.storeRegistrationId(context, regid);
